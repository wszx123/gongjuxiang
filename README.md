...
# 五、添加3x-ui一键脚本
- 功能不变，新版汉化。【来自MHSanaei：[https://github.com/Misaka-blog/hysteria-install](https://github.com/MHSanaei/3x-ui)，感谢】
- 一键脚本：
```
bash <(curl -Ls https://raw.githubusercontent.com/wszx123/gongjuxiang/refs/heads/main/3x-ui/install-3x-ui-2.sh)
```

- 功能不变，旧版汉化。【来自MHSanaei：[https://github.com/Misaka-blog/hysteria-install](https://github.com/MHSanaei/3x-ui)，感谢】
- 一键脚本：
```
